...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="iekt_ab")
    ...
    parser.add_argument("--ab_mode", type=str, default='nce',help="nce,nkase,nck,nrl")
    ...
    #python wandb_iekt_ab_train.py --ab_mode nck 