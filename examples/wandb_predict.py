...
def main(params):
    ...
    save_dir, batch_size, fusion_type, fold = params["save_dir"], params["bz"], params["fusion_type"].split(","), params["fold"]
    ...
    with open("configs/data_config.json") as fin:
        ...
        curconfig[dataset_name]["test_original_file"] = f"test_fold{fold}.csv"
        curconfig[dataset_name]["test_question_file"] = f"test_question_sequences_fold{fold}.csv"
        curconfig[dataset_name]["test_question_window_file"] = f"test_question_window_sequences_fold{fold}.csv"
        curconfig[dataset_name]["test_file"] = f"test_sequences_fold{fold}.csv"
        curconfig[dataset_name]["test_window_file"] = f"test_window_sequences_fold{fold}.csv"
