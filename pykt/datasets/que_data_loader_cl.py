...
class KTQueDataset4CL(Dataset):
    ...
    """
    def __init__(self, file_path, df, input_type, folds,concept_num,max_concepts, qtest=False):
        super(KTQueDataset4CL, self).__init__()
        ...
        processed_data = file_path + folds_str + "_qlevel_cl.pkl"
