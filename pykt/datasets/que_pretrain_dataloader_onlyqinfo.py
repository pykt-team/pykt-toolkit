...
class KTPretrainQueDatasetOnlyQinfo(Dataset):
    """Dataset for KT
    ...
    def __init__(self, file_path, input_type, folds, concept_num, max_concepts, qtest=False):
        super(KTPretrainQueDatasetOnlyQinfo, self).__init__()
        ...
        processed_data = file_path + folds_str + "_qlevel_onlyqinfo.pkl"
    ...
    def __load_data__(self, sequence_path, folds, pad_val=-1):
        ...
        """
        qtypdict = self.__load_qinfo__()
        dori = {"qseqs": [], "qtypes": [], "cseqs": [], "rseqs": [], "tseqs": [], "utseqs": [], "smasks": []}
