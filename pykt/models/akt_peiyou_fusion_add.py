...
import numpy as np
from .peiyou_emb_fusion_add import KCRouteEncoder, QuestionEncoder, GateEarlyFusion
...
class AKTPeiyouFusion(nn.Module):
    def __init__(self, n_croutes, n_question, n_pid, d_model, n_blocks, dropout, d_ff=256, 
        ...
        """
        self.model_name = "akt_peiyou_fusion"
...
class Architecture(nn.Module):
    def __init__(self, n_question,  n_blocks, d_model, d_feature,
        ...
        if model_type in {'akt_peiyou_fusion'}:
