...
def read_data_from_csv(read_file, write_file):
    ...
    df2.rename(columns={'skill':'skill_id'},inplace=True)
    df2.rename(columns={'problemId':'problem_id'},inplace=True)

    df2 = skill_difficult(df2,'skill_id','correct')
    df2 = question_difficult(df2,'problem_id','correct')
    
    df2.rename(columns={'skill_id':'skill'},inplace=True)
    df2.rename(columns={'problem_id':'problemId'},inplace=True)
